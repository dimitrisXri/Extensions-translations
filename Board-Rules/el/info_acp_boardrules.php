...
$lang = array_merge($lang, array(
	...
	// ACP Logs
	'ACP_BOARDRULES_SETTINGS_LOG'	=> '<strong>Οι κανόνες ιστοσελίδας άλλαξαν</strong>',
	'ACP_BOARDRULES_NOTIFY_LOG'		=> '<strong>Ειδοποίηση κανόνων ιστοσελίδας στάλθηκε σε όλα τα μέλη</strong>',
));
